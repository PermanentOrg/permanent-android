...
class Constants {
    companion object {
        ...
        const val FILE_FORMAT_ORIGINAL = "file.format.original"
        const val FILE_FORMAT_ARCHIVEMATICA_ACCESS = "file.format.archivematica.access"
        const val FILE_TYPE_PDF = "type.file.pdf.pdf"
        ...
        const val ERROR_INVITE_LOOKUP = "error.invite.lookup"
        const val RELATIONSHIP_FRIEND = "relation.friend"
