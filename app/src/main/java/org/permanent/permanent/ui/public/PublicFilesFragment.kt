...
class PublicFilesFragment : PermanentBaseFragment() {
    ...
    override fun connectViewModelEvents() {
        ...
        viewModel.getOnShowRecordMenuFragment().observe(this, onShowRecordOptionsFragment)
    ...
    override fun disconnectViewModelEvents() {
        ...
        viewModel.getOnShowRecordMenuFragment().removeObserver(onShowRecordOptionsFragment)
